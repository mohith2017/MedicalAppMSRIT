...
public class Attitude15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude15);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3m);
        next=(Button)findViewById(R.id.button5m);
        r=(RadioGroup)findViewById(R.id.groupattitudem);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonm: checked1="a";break;
                    case R.id.radioButton2m: checked1="b";break;
                    case R.id.radioButton3m: checked1="c";break;
                    case R.id.radioButton4m: checked1="d";break;
                    case R.id.radioButton5m: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude15.this, checked1,
                ...
                Intent i=new Intent(Attitude15.this,Attitude16.class);
                startActivity(i);
        ...
        contact.update(data15, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude15.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
