...
public class Attitude17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude17);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3o);
        next=(Button)findViewById(R.id.button5o);
        r=(RadioGroup)findViewById(R.id.groupattitudeo);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtono: checked1="a";break;
                    case R.id.radioButton2o: checked1="b";break;
                    case R.id.radioButton3o: checked1="c";break;
                    case R.id.radioButton4o: checked1="d";break;
                    case R.id.radioButton5o: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude17.this, checked1,
                ...
                Intent i=new Intent(Attitude17.this,Attitude18.class);
                startActivity(i);
        ...
        contact.update(data17, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude17.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
