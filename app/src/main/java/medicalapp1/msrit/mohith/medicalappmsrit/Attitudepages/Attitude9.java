...
public class Attitude9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude9);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3g);
        next=(Button)findViewById(R.id.button5g);
        r=(RadioGroup)findViewById(R.id.groupattitudeg);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtong: checked1="a";break;
                    case R.id.radioButton2g: checked1="b";break;
                    case R.id.radioButton3g: checked1="c";break;
                    case R.id.radioButton4g: checked1="d";break;
                    case R.id.radioButton5g: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude9.this, checked1,
                ...
                Intent i=new Intent(Attitude9.this,Attitude10.class);
                startActivity(i);
        ...
        contact.update(data9, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude9.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
