...
public class Knowledgekb7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb7);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb7);
        next=(Button)findViewById(R.id.button5kb7);
        r=(RadioGroup)findViewById(R.id.groupattitudekb7);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb7: checked1="a";break;
                    case R.id.radioButton2kb7: checked1="b";break;
                    case R.id.radioButton3kb7: checked1="c";break;
                    case R.id.radioButton4kb7: checked1="d";break;
                    case R.id.radioButton5kb7: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb7.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb7.this,Knowledgekb8.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data7, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb7.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
