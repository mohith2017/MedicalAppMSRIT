...
public class Knowledgekb10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb10);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb10);
        next=(Button)findViewById(R.id.button5kb10);
        r=(RadioGroup)findViewById(R.id.groupattitudekb10);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb10: checked1="a";break;
                    case R.id.radioButton2kb10: checked1="b";break;
                    case R.id.radioButton3kb10: checked1="c";break;
                    case R.id.radioButton4kb10: checked1="d";break;
                    case R.id.radioButton5kb10: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb10.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb10.this,Knowledgekb11.class);
                startActivity(i);
        ...
        contact.update(data10, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb10.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
