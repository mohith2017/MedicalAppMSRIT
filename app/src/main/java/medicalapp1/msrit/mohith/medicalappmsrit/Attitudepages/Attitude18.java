...
public class Attitude18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude18);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3p);
        next=(Button)findViewById(R.id.button5p);
        r=(RadioGroup)findViewById(R.id.groupattitudep);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonp: checked1="a";break;
                    case R.id.radioButton2p: checked1="b";break;
                    case R.id.radioButton3p: checked1="c";break;
                    case R.id.radioButton4p: checked1="d";break;
                    case R.id.radioButton5p: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude18.this, checked1,
                ...
                Intent i=new Intent(Attitude18.this,Attitude19.class);
                startActivity(i);
        ...
        contact.update(data18, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude18.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
