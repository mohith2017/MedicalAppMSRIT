...
public class Knowledgekb2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb2);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb2);
        next=(Button)findViewById(R.id.button5kb2);
        r=(RadioGroup)findViewById(R.id.groupattitudekb2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb2: checked1="a";break;
                    case R.id.radioButton2kb2: checked1="b";break;
                    case R.id.radioButton3kb2: checked1="c";break;
                    case R.id.radioButton4kb2: checked1="d";break;
                    case R.id.radioButton5kb2: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb2.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb2.this,Knowledgekb3.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data2, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb2.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
