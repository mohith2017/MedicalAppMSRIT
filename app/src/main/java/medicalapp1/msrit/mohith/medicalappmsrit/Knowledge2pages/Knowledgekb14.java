...
public class Knowledgekb14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb14);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb14);
        next=(Button)findViewById(R.id.button5kb14);
        r=(RadioGroup)findViewById(R.id.groupattitudekb14);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb14: checked1="a";break;
                    case R.id.radioButton2kb14: checked1="b";break;
                    case R.id.radioButton3kb14: checked1="c";break;
                    case R.id.radioButton4kb14: checked1="d";break;
                    case R.id.radioButton5kb14: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb14.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb14.this,Knowledgekb15.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data14, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb14.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
