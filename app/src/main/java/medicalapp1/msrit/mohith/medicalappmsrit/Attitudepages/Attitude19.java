...
public class Attitude19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude19);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3q);
        next=(Button)findViewById(R.id.button5q);
        r=(RadioGroup)findViewById(R.id.groupattitudeq);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonq: checked1="a";break;
                    case R.id.radioButton2q: checked1="b";break;
                    case R.id.radioButton3q: checked1="c";break;
                    case R.id.radioButton4q: checked1="d";break;
                    case R.id.radioButton5q: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude19.this, checked1,
                ...
                Intent i=new Intent(Attitude19.this,Attitude20.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data19, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude19.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
