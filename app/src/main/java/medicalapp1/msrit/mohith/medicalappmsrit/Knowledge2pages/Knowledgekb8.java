...
public class Knowledgekb8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb8);
        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb8);
        next=(Button)findViewById(R.id.button5kb8);
        r=(RadioGroup)findViewById(R.id.groupattitudekb8);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb8: checked1="a";break;
                    case R.id.radioButton2kb8: checked1="b";break;
                    case R.id.radioButton3kb8: checked1="c";break;
                    case R.id.radioButton4kb8: checked1="d";break;
                    case R.id.radioButton5kb8: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb8.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb8.this,Knowledgekb9.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data8, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb8.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
