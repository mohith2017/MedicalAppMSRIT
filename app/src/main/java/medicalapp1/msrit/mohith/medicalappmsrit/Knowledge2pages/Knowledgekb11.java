...
public class Knowledgekb11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb11);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb11);
        next=(Button)findViewById(R.id.button5kb11);
        r=(RadioGroup)findViewById(R.id.groupattitudekb11);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb11: checked1="a";break;
                    case R.id.radioButton2kb11: checked1="b";break;
                    case R.id.radioButton3kb11: checked1="c";break;
                    case R.id.radioButton4kb11: checked1="d";break;
                    case R.id.radioButton5kb11: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb11.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb11.this,Knowledgekb12.class);
                startActivity(i);
        ...
        contact.update(data11, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb11.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
