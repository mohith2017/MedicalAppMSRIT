...
public class Knowledgekb5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb5);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb5);
        next=(Button)findViewById(R.id.button5kb5);
        r=(RadioGroup)findViewById(R.id.groupattitudekb5);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb5: checked1="a";break;
                    case R.id.radioButton2kb5: checked1="b";break;
                    case R.id.radioButton3kb5: checked1="c";break;
                    case R.id.radioButton4kb5: checked1="d";break;
                    case R.id.radioButton5kb5: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb5.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb5.this,Knowledgekb6.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data5, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb5.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
