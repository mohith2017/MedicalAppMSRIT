...
public class Knowledgekb12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb12);


        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb12);
        next=(Button)findViewById(R.id.button5kb12);
        r=(RadioGroup)findViewById(R.id.groupattitudekb12);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb12: checked1="a";break;
                    case R.id.radioButton2kb12: checked1="b";break;
                    case R.id.radioButton3kb12: checked1="c";break;
                    case R.id.radioButton4kb12: checked1="d";break;
                    case R.id.radioButton5kb12: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb12.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb12.this,Knowledgekb13.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data12, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb12.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
