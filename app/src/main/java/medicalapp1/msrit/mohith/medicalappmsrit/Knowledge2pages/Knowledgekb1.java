...
public class Knowledgekb1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb1);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb1);
        next=(Button)findViewById(R.id.button5kb1);
        r=(RadioGroup)findViewById(R.id.groupattitudekb1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb1: checked1="a";break;
                    case R.id.radioButton2kb1: checked1="b";break;
                    case R.id.radioButton3kb1: checked1="c";break;
                    case R.id.radioButton4kb1: checked1="d";break;
                    case R.id.radioButton5kb1: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb1.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb1.this,Knowledgekb2.class);
                startActivity(i);
        ...
        contact.update(data, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb1.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
