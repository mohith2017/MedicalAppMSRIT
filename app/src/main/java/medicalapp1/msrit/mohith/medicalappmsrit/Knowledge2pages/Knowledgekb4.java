...
public class Knowledgekb4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb4);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb4);
        next=(Button)findViewById(R.id.button5kb4);
        r=(RadioGroup)findViewById(R.id.groupattitudekb4);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb4: checked1="a";break;
                    case R.id.radioButton2kb4: checked1="b";break;
                    case R.id.radioButton3kb4: checked1="c";break;
                    case R.id.radioButton4kb4: checked1="d";break;
                    case R.id.radioButton5kb4: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb4.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb4.this,Knowledgekb5.class);
                startActivity(i);
        ...
        contact.update(data4, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb4.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
