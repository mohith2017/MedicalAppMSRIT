...
public class Knowledgekb15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb15);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb15);
        next=(Button)findViewById(R.id.button5kb15);
        r=(RadioGroup)findViewById(R.id.groupattitudekb15);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb15: checked1="a";break;
                    case R.id.radioButton2kb15: checked1="b";break;
                    case R.id.radioButton3kb15: checked1="c";break;
                    case R.id.radioButton4kb15: checked1="d";break;
                    case R.id.radioButton5kb15: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb15.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb15.this,Knowledgekb16.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data15, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb15.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
