...
public class Attitude7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude7);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3f);
        next=(Button)findViewById(R.id.button5f);
        r=(RadioGroup)findViewById(R.id.groupattitudef);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonf: checked1="a";break;
                    case R.id.radioButton2f: checked1="b";break;
                    case R.id.radioButton3f: checked1="c";break;
                    case R.id.radioButton4f: checked1="d";break;
                    case R.id.radioButton5f: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude7.this, checked1,
                ...
                Intent i=new Intent(Attitude7.this,Attitude8.class);
                startActivity(i);
        ...
        contact.update(data7, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude7.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
