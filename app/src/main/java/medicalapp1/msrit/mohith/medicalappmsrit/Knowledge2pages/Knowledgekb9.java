...
public class Knowledgekb9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb9);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb9);
        next=(Button)findViewById(R.id.button5kb9);
        r=(RadioGroup)findViewById(R.id.groupattitudekb9);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb9: checked1="a";break;
                    case R.id.radioButton2kb9: checked1="b";break;
                    case R.id.radioButton3kb9: checked1="c";break;
                    case R.id.radioButton4kb9: checked1="d";break;
                    case R.id.radioButton5kb9: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb9.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb9.this,Knowledgekb10.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data9, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb9.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
