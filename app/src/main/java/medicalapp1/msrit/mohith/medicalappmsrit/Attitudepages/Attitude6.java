...
public class Attitude6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude6);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3e);
        next=(Button)findViewById(R.id.button5e);
        r=(RadioGroup)findViewById(R.id.groupattitudee);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtone: checked1="a";break;
                    case R.id.radioButton2e: checked1="b";break;
                    case R.id.radioButton3e: checked1="c";break;
                    case R.id.radioButton4e: checked1="d";break;
                    case R.id.radioButton5e: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude6.this, checked1,
                ...
                Intent i=new Intent(Attitude6.this,Attitude7.class);
                startActivity(i);
        ...
        contact.update(data6, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude6.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
