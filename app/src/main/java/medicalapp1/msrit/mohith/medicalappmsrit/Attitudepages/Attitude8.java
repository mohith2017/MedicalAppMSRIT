...
public class Attitude8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude8);
...
//                startActivity(i);
                Toast.makeText(Attitude8.this, checked1,
                ...
                Intent i=new Intent(Attitude8.this,Attitude9.class);
                startActivity(i);
        ...
        contact.update(data8, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude8.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
