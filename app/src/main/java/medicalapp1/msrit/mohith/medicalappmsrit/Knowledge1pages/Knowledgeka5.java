...
public class Knowledgeka5 extends AppCompatActivity {
    Button next;
    CheckBox a,b,c,d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgeka5);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();


        a=(CheckBox)findViewById(R.id.checkBoxka5);
        b=(CheckBox)findViewById(R.id.checkBox1ka5);
        c=(CheckBox)findViewById(R.id.checkBox2ka5);
        d=(CheckBox)findViewById(R.id.checkBox3ka5);
        next=(Button)findViewById(R.id.buttonka5);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Knowledgeka5.this, Knowledgeka6.class);
                startActivity(i);
            }
        });
    }
    private void UpdateData(String a1, String b1, String c1, String d1) {
        ...
        contact.update("5",newOptions)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgeka5.this, "Updated Successfully",
