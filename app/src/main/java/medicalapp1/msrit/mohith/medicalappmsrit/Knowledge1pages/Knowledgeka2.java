...
public class Knowledgeka2 extends AppCompatActivity {
    Button next;
    CheckBox a,b,c,d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgeka2);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();


        a=(CheckBox)findViewById(R.id.checkBoxka2);
        b=(CheckBox)findViewById(R.id.checkBox1ka2);
        c=(CheckBox)findViewById(R.id.checkBox2ka2);
        d=(CheckBox)findViewById(R.id.checkBox3ka2);
        next=(Button)findViewById(R.id.buttonka2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Knowledgeka2.this, Knowledgeka3.class);
                startActivity(i);
            }
        });
    ...
    private void UpdateData(String a1, String b1, String c1, String d1) {
        ...
        contact.update("2",newOptions)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgeka2.this, "Updated Successfully",
