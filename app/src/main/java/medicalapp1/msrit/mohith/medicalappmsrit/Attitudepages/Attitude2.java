...
public class Attitude2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude2);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3a);
        next=(Button)findViewById(R.id.button5a);
        r=(RadioGroup)findViewById(R.id.groupattitudea);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtona: checked1="a";break;
                    case R.id.radioButton2a: checked1="b";break;
                    case R.id.radioButton3a: checked1="c";break;
                    case R.id.radioButton4a: checked1="d";break;
                    case R.id.radioButton5a: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude2.this, checked1,
                ...
                Intent i=new Intent(Attitude2.this,Attitude3.class);
                startActivity(i);
        ...
        contact.update(data2, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude2.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
