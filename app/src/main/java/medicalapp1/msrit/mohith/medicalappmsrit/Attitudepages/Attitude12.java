...
public class Attitude12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude12);


        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3j);
        next=(Button)findViewById(R.id.button5j);
        r=(RadioGroup)findViewById(R.id.groupattitudej);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonj: checked1="a";break;
                    case R.id.radioButton2j: checked1="b";break;
                    case R.id.radioButton3j: checked1="c";break;
                    case R.id.radioButton4j: checked1="d";break;
                    case R.id.radioButton5j: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude12.this, checked1,
                ...
                Intent i=new Intent(Attitude12.this,Attitude13.class);
                startActivity(i);
        ...
        contact.update(data12, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude12.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
