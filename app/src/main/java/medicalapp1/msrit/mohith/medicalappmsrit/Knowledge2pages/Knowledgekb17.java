...
public class Knowledgekb17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb17);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb17);
        next=(Button)findViewById(R.id.button5kb17);
        r=(RadioGroup)findViewById(R.id.groupattitudekb17);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb17: checked1="a";break;
                    case R.id.radioButton2kb17: checked1="b";break;
                    case R.id.radioButton3kb17: checked1="c";break;
                    case R.id.radioButton4kb17: checked1="d";break;
                    case R.id.radioButton5kb17: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb17.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb17.this,Knowledgekb18.class);
                startActivity(i);
    ...
    private void UpdateData(String a) {
        ...
        contact.update(data17, a)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb17.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
