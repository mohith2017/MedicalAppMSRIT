...
public class Attitude14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude14);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3l);
        next=(Button)findViewById(R.id.button5l);
        r=(RadioGroup)findViewById(R.id.groupattitudel);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonl: checked1="a";break;
                    case R.id.radioButton2l: checked1="b";break;
                    case R.id.radioButton3l: checked1="c";break;
                    case R.id.radioButton4l: checked1="d";break;
                    case R.id.radioButton5l: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude14.this, checked1,
                ...
                Intent i=new Intent(Attitude14.this,Attitude15.class);
                startActivity(i);
        ...
        contact.update(data14, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude14.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
