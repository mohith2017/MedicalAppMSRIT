...
public class Attitude5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attitude5);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3d);
        next=(Button)findViewById(R.id.button5d);
        r=(RadioGroup)findViewById(R.id.groupattituded);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtond: checked1="a";break;
                    case R.id.radioButton2d: checked1="b";break;
                    case R.id.radioButton3d: checked1="c";break;
                    case R.id.radioButton4d: checked1="d";break;
                    case R.id.radioButton5d: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Attitude5.this, checked1,
                ...
                Intent i=new Intent(Attitude5.this,Attitude6.class);
                startActivity(i);
        ...
        contact.update(data5, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Attitude5.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
