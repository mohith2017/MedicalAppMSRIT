...
public class Knowledgekb16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgekb16);


        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();

        back=(Button)findViewById(R.id.button3kb16);
        next=(Button)findViewById(R.id.button5kb16);
        r=(RadioGroup)findViewById(R.id.groupattitudekb16);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(id1)
                {
                    case R.id.radioButtonkb16: checked1="a";break;
                    case R.id.radioButton2kb16: checked1="b";break;
                    case R.id.radioButton3kb16: checked1="c";break;
                    case R.id.radioButton4kb16: checked1="d";break;
                    case R.id.radioButton5kb16: checked1="e";break;
...
//                startActivity(i);
                Toast.makeText(Knowledgekb16.this, checked1,
                ...
                Intent i=new Intent(Knowledgekb16.this,Knowledgekb17.class);
                startActivity(i);
        ...
        contact.update(data16, a)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgekb16.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
