...
public class Knowledgeka1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgeka1);
        ...
        a=(CheckBox)findViewById(R.id.checkBoxka1);
        b=(CheckBox)findViewById(R.id.checkBox1ka1);
        c=(CheckBox)findViewById(R.id.checkBox2ka1);
        d=(CheckBox)findViewById(R.id.checkBox3ka1);
        next=(Button)findViewById(R.id.buttonka1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Knowledgeka1.this, Knowledgeka2.class);
                startActivity(i);
            }
        });
    ...
    private void UpdateData(String a1, String b1, String c1, String d1) {
        ...
        contact.update("1",newOptions)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgeka1.this, "Updated Successfully",
