...
public class Knowledgeka3 extends AppCompatActivity {
    Button next;
    CheckBox a,b,c,d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgeka3);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();


        a=(CheckBox)findViewById(R.id.checkBoxka3);
        b=(CheckBox)findViewById(R.id.checkBox1ka3);
        c=(CheckBox)findViewById(R.id.checkBox2ka3);
        d=(CheckBox)findViewById(R.id.checkBox3ka3);
        next=(Button)findViewById(R.id.buttonka3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Knowledgeka3.this, Knowledgeka4.class);
                startActivity(i);
            }
        });
    ...
    private void UpdateData(String a1, String b1, String c1, String d1) {
        ...
        contact.update("3",newOptions)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgeka3.this, "Updated Successfully",
