...
public class Knowledgeka6 extends AppCompatActivity {
    Button next;
    CheckBox a,b,c,d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knowledgeka6);

        pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        editor = pref.edit();


        a=(CheckBox)findViewById(R.id.checkBoxka6);
        b=(CheckBox)findViewById(R.id.checkBox1ka6);
        c=(CheckBox)findViewById(R.id.checkBox2ka6);
        d=(CheckBox)findViewById(R.id.checkBox3ka6);
        next=(Button)findViewById(R.id.buttonka6);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Knowledgeka6.this, Knowledgeka7.class);
                startActivity(i);
            }
        });
    ...
    private void UpdateData(String a1, String b1, String c1, String d1) {
        ...
        contact.update("6",newOptions)

                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Knowledgeka6.this, "Updated Successfully",
